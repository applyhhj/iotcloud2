...
@SuppressWarnings("all") public class TSiteDetails implements org.apache.thrift.TBase<TSiteDetails, TSiteDetails._Fields>, java.io.Serializable, Cloneable, Comparable<TSiteDetails> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TSiteDetails");
  ...
  private static final org.apache.thrift.protocol.TField BROKERS_FIELD_DESC = new org.apache.thrift.protocol.TField("brokers", org.apache.thrift.protocol.TType.LIST, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new TSiteDetailsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TSiteDetailsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TSiteDetails.class, metaDataMap);
  }
   ...
   */
  public TSiteDetails(TSiteDetails other) {
...
;
    ...
    if (other.isSetBrokers()) {
      List<TBroker> __this__brokers = new ArrayList<TBroker>(other.brokers.size());
      for (TBroker other_element : other.brokers) {
        __this__brokers.add(new TBroker(other_element));
      }
      this.brokers = __this__brokers;
    }
  }

  public TSiteDetails deepCopy() {
    return new TSiteDetails(this);
  }
  ...
  public TSiteDetails setSiteId(String siteId) {
    this.siteId = siteId;
    return this;
  }
  ...
  public TSiteDetails setPort(int port) {
    this.port = port;
    setPortIsSet(true);
    return this;
  }
  ...
  public TSiteDetails setHost(String host) {
    this.host = host;
    return this;
  }
  ...
  public TSiteDetails setMetadata(byte[] metadata) {
    setMetadata(metadata == null ? (ByteBuffer)null : ByteBuffer.wrap(metadata));
    return this;
  }

  public TSiteDetails setMetadata(ByteBuffer metadata) {
  ...
  public java.util.Iterator<TBroker> getBrokersIterator() {
    return (this.brokers == null) ? null : this.brokers.iterator();
  }

  public void addToBrokers(TBroker elem) {
    if (this.brokers == null) {
      this.brokers = new ArrayList<TBroker>();
    }
    this.brokers.add(elem);
  }

  public List<TBroker> getBrokers() {
    return this.brokers;
  }

  public TSiteDetails setBrokers(List<TBroker> brokers) {
    this.brokers = brokers;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TSiteDetails)
      return this.equals((TSiteDetails)that);
    return false;
  }

  public boolean equals(TSiteDetails that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TSiteDetails other) {
    ...
    lastComparison = Boolean.valueOf(isSetBrokers()).compareTo(other.isSetBrokers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBrokers()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TSiteDetails(");
    boolean first = true;
  ...
  private static class TSiteDetailsStandardSchemeFactory implements SchemeFactory {
    public TSiteDetailsStandardScheme getScheme() {
      return new TSiteDetailsStandardScheme();
    }
  }

  private static class TSiteDetailsStandardScheme extends StandardScheme<TSiteDetails> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TSiteDetails struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.brokers = new ArrayList<TBroker>(_list18.size);
                for (int _i19 = 0; _i19 < _list18.size; ++_i19)
                {
                  TBroker _elem20;
                  _elem20 = new TBroker();
                  _elem20.read(iprot);
                  struct.brokers.add(_elem20);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSiteDetails struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TSiteDetailsTupleSchemeFactory implements SchemeFactory {
    public TSiteDetailsTupleScheme getScheme() {
      return new TSiteDetailsTupleScheme();
    }
  }

  private static class TSiteDetailsTupleScheme extends TupleScheme<TSiteDetails> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TSiteDetails struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBrokers()) {
        {
          ...
          for (TBroker _iter22 : struct.brokers)
          {
            _iter22.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TSiteDetails struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.brokers = new ArrayList<TBroker>(_list23.size);
          for (int _i24 = 0; _i24 < _list23.size; ++_i24)
          {
            TBroker _elem25;
            _elem25 = new TBroker();
            _elem25.read(iprot);
            struct.brokers.add(_elem25);
          }
        }
        struct.setBrokersIsSet(true);
      }
