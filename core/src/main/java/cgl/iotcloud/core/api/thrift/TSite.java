...
@SuppressWarnings("all") public class TSite implements org.apache.thrift.TBase<TSite, TSite._Fields>, java.io.Serializable, Cloneable, Comparable<TSite> {
  ...
  static {
    schemes.put(StandardScheme.class, new TSiteStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TSiteTupleSchemeFactory());
  }
...
;
  ...
  public TSite setSiteId(String siteId) {
    this.siteId = siteId;
    return this;
  }
  ...
  public TSite setHost(String host) {
    this.host = host;
    return this;
  }
  ...
  public TSite setMetadata(byte[] metadata) {
    setMetadata(metadata == null ? (ByteBuffer)null : ByteBuffer.wrap(metadata));
    return this;
  }

  public TSite setMetadata(ByteBuffer metadata) {
  ...
  public TSite setBrokers(List<TBroker> brokers) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TSite(");
    boolean first = true;
  ...
  private static class TSiteStandardSchemeFactory implements SchemeFactory {
    public TSiteStandardScheme getScheme() {
      return new TSiteStandardScheme();
    }
  }

  private static class TSiteStandardScheme extends StandardScheme<TSite> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.brokers = new ArrayList<TBroker>(_list28.size);
                for (int _i29 = 0; _i29 < _list28.size; ++_i29)
                {
                  TBroker _elem30;
                  _elem30 = new TBroker();
                  _elem30.read(iprot);
                  struct.brokers.add(_elem30);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.brokers != null) {
        if (struct.isSetBrokers()) {
          oprot.writeFieldBegin(BROKERS_FIELD_DESC);
          {
            ...
            for (TBroker _iter31 : struct.brokers)
            {
              _iter31.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TSiteTupleSchemeFactory implements SchemeFactory {
    public TSiteTupleScheme getScheme() {
      return new TSiteTupleScheme();
    }
  }

  private static class TSiteTupleScheme extends TupleScheme<TSite> {
      ...
      if (struct.isSetBrokers()) {
        {
          ...
          for (TBroker _iter32 : struct.brokers)
          {
            _iter32.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.brokers = new ArrayList<TBroker>(_list33.size);
          for (int _i34 = 0; _i34 < _list33.size; ++_i34)
          {
            TBroker _elem35;
            _elem35 = new TBroker();
            _elem35.read(iprot);
            struct.brokers.add(_elem35);
          }
        }
        struct.setBrokersIsSet(true);
      }
