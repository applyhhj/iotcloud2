...
@SuppressWarnings("all") public class TSiteDetailsResponse implements org.apache.thrift.TBase<TSiteDetailsResponse, TSiteDetailsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TSiteDetailsResponse> {
  ...
  public TSite details; // optional
  public TResponse state; // required
  ...
  public TSiteDetailsResponse(TSiteDetailsResponse other) {
    if (other.isSetDetails()) {
      this.details = new TSite(other.details);
    }
    if (other.isSetState()) {
      this.state = new TResponse(other.state);
    }
  }
  ...
  public TSite getDetails() {
    return this.details;
  }

  public TSiteDetailsResponse setDetails(TSite details) {
  ...
  public TResponse getState() {
    return this.state;
  }

  public TSiteDetailsResponse setState(TResponse state) {
    this.state = state;
    return this;
  }
