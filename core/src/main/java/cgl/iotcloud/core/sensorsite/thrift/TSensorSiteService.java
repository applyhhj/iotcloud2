...
@SuppressWarnings("all") public class TSensorSiteService {
  ...
  public interface AsyncIface {
    ...
    public void unDeploySensor(String id, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.unDeploySensor_call> resultHandler) throws org.apache.thrift.TException;

    public void startSensor(String id, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.startSensor_call> resultHandler) throws org.apache.thrift.TException;

    public void stopSensor(String id, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.stopSensor_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void unDeploySensor(String id, org.apache.thrift.async.AsyncMethodCallback<unDeploySensor_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class unDeploySensor_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String id;
      public unDeploySensor_call(String id, org.apache.thrift.async.AsyncMethodCallback<unDeploySensor_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
      }
    ...
    public void startSensor(String id, org.apache.thrift.async.AsyncMethodCallback<startSensor_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class startSensor_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String id;
      public startSensor_call(String id, org.apache.thrift.async.AsyncMethodCallback<startSensor_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
      }
    ...
    public void stopSensor(String id, org.apache.thrift.async.AsyncMethodCallback<stopSensor_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class stopSensor_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String id;
      public stopSensor_call(String id, org.apache.thrift.async.AsyncMethodCallback<stopSensor_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
      }
